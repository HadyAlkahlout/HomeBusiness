...
class NewProductFragment : Fragment(), HomeMealAdapter.OnClickListener {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        txtTitleAll.text = getString(R.string.new_meals)
    ...
    override fun onClickItem(data: NewProduct) {
        ...
        findNavController().navigate(
            R.id.action_newProductFragment_to_productDetailsFragment,
            bundle
        )
    }
