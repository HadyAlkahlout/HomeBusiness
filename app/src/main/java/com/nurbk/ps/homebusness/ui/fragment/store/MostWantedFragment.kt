...
import com.nurbk.ps.homebusness.adapter.ProductStoresAdapter
...
class MostWantedFragment(val data: ArrayList<Product>, val idMarket: String) : Fragment(),
    ProductStoresAdapter.OnClickListener {

    private lateinit var mBinding: FragmentStoreMostBinding
    val mostAdapter = ProductStoresAdapter(data, this)
    ...
    override fun onCreateView(
        ...
        mBinding = FragmentStoreMostBinding.inflate(inflater, container, false).apply {
    ...
    override fun addFav(data: Product, position: Int) {
        if (getShare.getString(Constant.TOKEN, "") == null || getShare.getString(
            ...
            mostAdapter.notifyItemChanged(position)
            data.fav = !data.fav
        }
    }
}